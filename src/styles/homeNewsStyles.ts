export const homeNewsStyles = {
  ...
  submitBtnModificator:
    'text-black bg-lightBlue py-[3px] px-[15px] hover:bg-darkBlue transition-all duration-75 hover:text-white transition-all duration-150 rounded-[4px] max-w-[72px] w-full h-[30px] flex justify-center items-center',
};
